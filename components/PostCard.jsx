  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      ...
      <div className='text-center'>
        <Link
        href={`/post/${post.slug}`}>
          <span className='transition duration-500 transform hover:-translate-y-1 inline-block bg-[#b0845d] text-lg
          font-medium rounded-full px-8 py-3 curser-pointer text-white'>Continue reading</span>
        </Link>
      </div>
    </div>
  )
